...
/*   Updated: 2025/06/19 13:58:36 by Home             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void fill_cylinder_position(t_cylinder *cylinder, char **coords, t_scene *scene);
static void fill_cylinder_orientation(t_cylinder *cylinder, char **orientation, t_scene *scene);
static void fill_cylinder_color(t_cylinder *cylinder, char **rgb, t_scene *scene);
